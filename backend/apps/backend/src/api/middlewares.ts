...
const reviewUpload = multer({ storage: multer.memoryStorage(), limits: { files: 5, fileSize: 4 * 1024 * 1024 } })
  ...
  routes: [
    {
      ...
      method: ["POST"],
      middlewares: [authenticate("customer", ["bearer"]), reviewUpload.array("images", 5)],
    },
    {
