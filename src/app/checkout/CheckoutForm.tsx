    ...
    <div className="checkout-layout">
      <form onSubmit={placeOrder}>
        ...
        <div className="checkout-payment-options" aria-label="Payment method">
          <div className="checkout-payment-method selected"><div className="qrph-mark"><svg viewBox="0 0 48 48" aria-hidden="true"><path d="M5 5h14v14H5zM9 9v6h6V9H9ZM29 5h14v14H29zM33 9v6h6V9h-6ZM5 29h14v14H5zM9 33v6h6v-6H9ZM27 27h6v6h-6zM37 27h6v6h-6zM27 37h6v6h-6zM35 35h8v8h-4v-4h-4z" /></svg><b>QR<span>Ph</span></b></div><div><small>Payment method</small><strong>QR Ph</strong><p>Scan using GCash, Maya, or a participating banking app.</p></div><b>Selected</b></div>
          <div className="checkout-payment-method disabled" aria-disabled="true"><div className="cod-mark"><svg viewBox="0 0 48 48" aria-hidden="true"><rect x="5" y="12" width="38" height="25" rx="4" /><circle cx="24" cy="24.5" r="6" /><path d="M10 17c3 0 5-2 5-5M38 17c-3 0-5-2-5-5M10 32c3 0 5 2 5 5M38 32c-3 0-5 2-5 5" /></svg></div><div><small>Payment method</small><strong>Cash on Delivery (COD)</strong><p>Payment upon delivery is not available yet.</p></div><b>Unavailable</b></div>
        </div>
